...
switch (power_type) {
    ...
    case PowerType.ATK:
        draw_sprite_ext(SPR_ATK_Up, 0, x, y, 1.5, 1.5, 0, c_white, 1);
        break;
    ...
    case PowerType.SWORD:
        draw_sprite_ext(SPR_TreeATK, 0, x, y, 1.5, 1.5, 0, c_white, 1);
        break;
		
    case PowerType.BOULDER:
        draw_sprite_ext(SPR_BoulderATK, 0, x, y, 1.5, 1.5, 0, c_white, 1);
        break;
}