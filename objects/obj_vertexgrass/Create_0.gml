...
//Mode 1 variables
grass_radius = 128; //Radius around the object for creating the grass
//----------------
...
//General variables
grass_number = 10; //Number of grass sprites inside the room
...
grass_wind = 0.02; //Power of the grass swaying
